...
test('document type confirmation uses a generic Element Plus dialog', () => {
  ...
  assert.match(dialogMarkup, /简历信息无误/)
  assert.match(dialogMarkup, /简历信息有误/)
  assert.match(dialogMarkup, /不是简历/)
  assert.match(dialogMarkup, /取消/)
  assert.match(dialogMarkup, /confirm_resume_as_extracted/)
  assert.match(dialogMarkup, /confirm_resume_with_corrections/)
